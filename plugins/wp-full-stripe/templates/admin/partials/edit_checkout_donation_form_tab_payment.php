...
<table class="form-table">
    <tr valign="top">
        ...
        <td>
            <?php esc_html_e( 'Checkout donation form', MM_WPFS::L10N_DOMAIN_ADMIN ); ?>
        </td>
    </tr>
    <tr valign="top">
        <th scope="row">
        ...
        <td>
            ...
            <p class="description"><?php esc_html_e( 'This name will be used to identify this form in the shortcode i.e. [fullstripe_form name="formName" type="checkout_donation"].', MM_WPFS::L10N_DOMAIN_ADMIN ); ?></p>
        </td>
    </tr>
    ...
    <tr valign="top" id="donation_amount_list_row">
        ...
        <td>
            ...
            <p class="description"><?php esc_html_e( 'The amount in the smallest unit for the currency. i.e. for $10.00 enter 1000, for ¥10 enter 10. You can use drag\'n\'drop to reorder the donation amounts.', MM_WPFS::L10N_DOMAIN_ADMIN ); ?></p>
            <br/>
