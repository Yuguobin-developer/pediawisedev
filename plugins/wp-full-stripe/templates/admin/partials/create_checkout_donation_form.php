...
<h2 id="create-checkout-donation-form-tabs" class="nav-tab-wrapper wpfs-admin-form-tabs">
    <a href="#create-checkout-donation-form-tab-payment" class="nav-tab"><?php esc_html_e( 'Payment', MM_WPFS::L10N_DOMAIN_ADMIN ); ?></a>
    <a href="#create-checkout-donation-form-tab-appearance" class="nav-tab"><?php esc_html_e( 'Appearance', MM_WPFS::L10N_DOMAIN_ADMIN ); ?></a>
    <a href="#create-checkout-donation-form-tab-custom-fields" class="nav-tab"><?php esc_html_e( 'Custom Fields', MM_WPFS::L10N_DOMAIN_ADMIN ); ?></a>
    <a href="#create-checkout-donation-form-tab-actions-after-payment" class="nav-tab"><?php esc_html_e( 'Actions after payment', MM_WPFS::L10N_DOMAIN_ADMIN ); ?></a>
</h2>
    ...
    <div id="create-checkout-donation-form-tab-payment" class="wpfs-tab-content">
        <table class="form-table">
            <tr valign="top">
                ...
                <td><?php esc_html_e( 'Checkout donation form', MM_WPFS::L10N_DOMAIN_ADMIN ); ?></td>
            </tr>
            <tr valign="top">
                <th scope="row">
        ...
        <table class="form-table">
            <tr valign="top">
                ...
                <td>
                    ...
                    <p class="description"><?php esc_html_e( 'The name of the product or service sold using this form.', MM_WPFS::L10N_DOMAIN_ADMIN ); ?></p>
                </td>
            </tr>
            <tr valign="top">
                <th scope="row">
                ...
                <td>
                    ...
                    <p class="description"><?php esc_html_e( 'A short description (one line) about the product or service sold using this form.', MM_WPFS::L10N_DOMAIN_ADMIN ); ?></p>
                </td>
            </tr>
            <tr valign="top">
                <th scope="row">
            ...
            <tr valign="top">
                ...
                <td>
                    <input type="text" class="regular-text" name="open_form_button_text" id="open_form_button_text" value="<?php esc_html_e( 'Donate', MM_WPFS::L10N_DOMAIN_ADMIN ); ?>" maxlength="<?php echo $form_data::OPEN_BUTTON_TITLE_LENGTH; ?>">
