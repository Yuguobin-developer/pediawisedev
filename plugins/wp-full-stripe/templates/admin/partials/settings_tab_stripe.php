...
if ( MM_WPFS_Utils::isDemoMode() ) {
	$test_secret_key      = __( 'Test secret key here', MM_WPFS::L10N_DOMAIN_ADMIN );
	$test_publishable_key = __( 'Test publishable key here', MM_WPFS::L10N_DOMAIN_ADMIN );
	$live_secret_key      = __( 'Live secret key here', MM_WPFS::L10N_DOMAIN_ADMIN );
	$live_publishable_key = __( 'Live publishable key here', MM_WPFS::L10N_DOMAIN_ADMIN );
...
?>
<div id="stripe-tab">
	<p class="alert alert-info"><?php _e( 'The Stripe API keys are required for payments to work. You can find your keys on your <a href="https://dashboard.stripe.com/account/apikeys" target="_blank">Stripe Dashboard -> API</a> page', MM_WPFS::L10N_DOMAIN_ADMIN ); ?></p>
	...
	<form class="form-horizontal" action="#" method="post" id="settings-stripe-form">
		...
		<table class="form-table">
			<tr valign="top">
				<th scope="row">
					<label class="control-label"><?php _e( "API mode: ", MM_WPFS::L10N_DOMAIN_ADMIN ); ?> </label>
				</th>
				<td>
					<label class="radio">
			...
			<tr valign="top">
				<th scope="row">
					<label class="control-label" for="publishKey_test"><?php _e( "Stripe Test Publishable Key: ", MM_WPFS::L10N_DOMAIN_ADMIN ); ?></label>
				</th>
				<td>
			...
			<tr valign="top">
				<th scope="row">
					<label class="control-label" for="secretKey_test"><?php _e( "Stripe Test Secret Key: ", MM_WPFS::L10N_DOMAIN_ADMIN ); ?> </label>
				</th>
				<td>
			...
			<tr valign="top">
				<th scope="row">
					<label class="control-label" for="publishKey_live"><?php _e( "Stripe Live Publishable Key: ", MM_WPFS::L10N_DOMAIN_ADMIN ); ?></label>
				</th>
				<td>
			...
			<tr valign="top">
				<th scope="row">
					<label class="control-label" for="secretKey_live"><?php _e( "Stripe Live Secret Key: ", MM_WPFS::L10N_DOMAIN_ADMIN ); ?> </label>
				</th>
				<td>
		...
		<table class="form-table">
			<tr valign="top">
				<th scope="row">
					<label class="control-label"><?php _e( 'Stripe Webhook URL: ', MM_WPFS::L10N_DOMAIN_ADMIN ); ?></label>
				</th>
				<td>
					<input id="stripe-webhook-url" class="large-text" type="text" value="<?php echo $webhook_url ?>" readonly>
					<p class="description"><?php printf( __( 'This URL must be set in Stripe as a webhook endpoint. See the <a target="_blank" href="%s">"Setup" chapter</a> of the "Help" page for more information.', MM_WPFS::L10N_DOMAIN_ADMIN ), admin_url( "admin.php?page=fullstripe-help#" ) ); ?>
					</p>
				</td>
			</tr>
		</table>
