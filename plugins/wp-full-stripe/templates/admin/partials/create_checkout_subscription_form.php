...
<?php else: ?>
	<h2 id="create-checkout-subscription-form-tabs" class="nav-tab-wrapper wpfs-admin-form-tabs">
		<a href="#create-checkout-subscription-form-tab-payment" class="nav-tab"><?php esc_html_e( 'Payment', MM_WPFS::L10N_DOMAIN_ADMIN ); ?></a>
		<a href="#create-checkout-subscription-form-tab-finance" class="nav-tab"><?php esc_html_e( 'Finance', MM_WPFS::L10N_DOMAIN_ADMIN ); ?></a>
		<a href="#create-checkout-subscription-form-tab-appearance" class="nav-tab"><?php esc_html_e( 'Appearance', MM_WPFS::L10N_DOMAIN_ADMIN ); ?></a>
		<a href="#create-checkout-subscription-form-tab-custom-fields" class="nav-tab"><?php esc_html_e( 'Custom Fields', MM_WPFS::L10N_DOMAIN_ADMIN ); ?></a>
		<a href="#create-checkout-subscription-form-tab-actions-after-payment" class="nav-tab"><?php esc_html_e( 'Actions after payment', MM_WPFS::L10N_DOMAIN_ADMIN ); ?></a>
	</h2>
	<form class="form-horizontal wpfs-admin-form" action="" method="POST" id="create-checkout-subscription-form">
		...
		<div id="create-checkout-subscription-form-tab-payment" class="wpfs-tab-content">
			<table class="form-table">
				<tr valign="top">
					...
					<td><?php esc_html_e( 'Checkout subscription form', MM_WPFS::L10N_DOMAIN_ADMIN ); ?></td>
				</tr>
				<tr valign="top">
					<th scope="row">
					...
					<td>
						...
						<p class="description"><?php esc_html_e( 'This name will be used to identify this form in the shortcode i.e. [fullstripe_form name="formName" type="popup_subscription"].', MM_WPFS::L10N_DOMAIN_ADMIN ); ?></p>
					</td>
				</tr>
				<tr valign="top">
					<th scope="row">
					...
					<td>
						...
						<p class="description"><?php esc_html_e( 'Allow customers to choose how many subscriptions they want to subscribe.', MM_WPFS::L10N_DOMAIN_ADMIN ); ?></p>
					</td>
				</tr>
		...
		<div id="create-checkout-subscription-form-tab-appearance" class="wpfs-tab-content">
			<?php
			$open_form_button_text_value = __( 'Subscribe', MM_WPFS::L10N_DOMAIN_ADMIN );
