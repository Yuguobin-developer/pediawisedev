...
?>
	<tr id="redirect_to_row" valign="top" <?php echo ( $form->redirectOnSuccess == '0' ) ? 'style="display: none;"' : '' ?>>
		<th scope="row">
			<label class="control-label"><?php esc_html_e( 'Redirect to:', MM_WPFS::L10N_DOMAIN_ADMIN ); ?> </label>
		</th>
		<td>
			<label class="radio inline">
				...
				<?php esc_html_e( 'Page or Post', MM_WPFS::L10N_DOMAIN_ADMIN ); ?>
			</label>
			<label class="radio inline">
				...
				<?php esc_html_e( 'URL entered manually', MM_WPFS::L10N_DOMAIN_ADMIN ); ?>
			</label>
			<div id="redirect_to_page_or_post_section" <?php echo( $form->redirectToPageOrPost == 0 ? 'style="display: none;"' : '' ) ?>>
				...
				<div class="ui-widget">
					<select name="form_redirect_page_or_post_id" id="form_redirect_page_or_post_id" <?php echo ( $form->redirectOnSuccess == '0' ) ? 'disabled' : '' ?>>
						<option value=""><?php esc_html_e( 'Select from the list or start typing', MM_WPFS::L10N_DOMAIN_ADMIN ); ?></option>
						<?php
				...
				<label class="checkbox inline">
					<input type="checkbox" name="showDetailedSuccessPage" id="showDetailedSuccessPage" <?php echo ( $form->redirectOnSuccess == '0' ) ? 'disabled' : '' ?> value="1" <?php echo $form->showDetailedSuccessPage == '0' ? '' : 'checked'; ?>><?php esc_html_e( 'Allow placeholder tokens on Thank You pages?', MM_WPFS::L10N_DOMAIN_ADMIN ); ?>
				</label>
			...
			<div id="redirect_to_url_section" <?php echo( $form->redirectToPageOrPost == 1 ? 'style="display: none;"' : '' ) ?>>
				<input type="text" class="regular-text" name="form_redirect_url" id="form_redirect_url" <?php echo ( $form->redirectOnSuccess == '0' ) ? 'disabled' : '' ?> placeholder="<?php esc_attr_e( 'Enter URL', MM_WPFS::L10N_DOMAIN_ADMIN ); ?>" value="<?php echo $form->redirectUrl; ?>" maxlength="<?php echo $form_data::REDIRECT_URL_LENGTH; ?>">
			</div>
		</td>
	</tr>
